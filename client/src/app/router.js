...
// const LazySurveyCreateHandler = lazy(() =>
//   import("../views/survey/SurveyCreateHandler")
// );

const LazyDisplayHandle = lazy(() => import("../views/pages/displayHandle"));
...
const LazySurveyAuthen = lazy(() => import("../views/pages/surveyAuthen"));
...
const LazyDisplay = lazy(() => import("../views/pages/DisplaySurvey"));
// Error Pages
    ...
    return (
      ...
      <BrowserRouter basename="/">
        <Switch>
          ...
          {/* <MainLayoutRoutes
            exact
            path="/survey/surveycreate-handler"
            render={matchprops => (
              <Suspense fallback={<Spinner />}>
                <LazySurveyCreateHandler {...matchprops} />
              </Suspense>
            )}
          /> */}
          ...
          <FullPageLayout
            exact
            path="/pages/displayhandle"
            render={matchprops => (
              <Suspense fallback={<Spinner />}>
                <LazyDisplayHandle {...matchprops} />
              </Suspense>
            )}
          />
          <FullPageLayout
            exact
            path="/pages/surveyauthen"
            render={matchprops => (
              <Suspense fallback={<Spinner />}>
                <LazySurveyAuthen {...matchprops} />
              </Suspense>
            )}
          />
